...
class CatdevVirtualDeviceLatch extends CatdevDevice implements CatdevConstants,
      CatreDeviceListener
{
...
CatdevVirtualDeviceLatch(CatreUniverse uu,CatreStore cs,Map<String,Object> map)
{
   super(uu);
...
}       // end of class CatdevVirtualDeviceLatch




/* end of CatdevVirtualDeviceLatch.java */
